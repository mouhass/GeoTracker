...
- In terminal run the command flutter doctor to verify that everything is running smoothly
- In case of errors follow the instructions pointed out by the flutter doctor in terminal
### 6- Running 
- Just execute the commmand Flutter run
